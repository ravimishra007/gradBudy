...
const Testimonials = () => {
    return (
        <section id='Featured_Courses' className=" mt-[-80px] ">
            <div className='relative'>
                <div className="absolute w-full -z-10">
                    <div className="bg-[#2C1C5F] flex-center flex-col text-white text-center py-16 pb-52 px-5 lg:px-0">
                        ...
                        <p className="paragraph">Hear from Our Successful Students</p>
                    </div>
                </div>
...
const TestimonialsCard = ({ name, role, says }: TestimonialsCardProp) => {
    return (
        <div>
            ...
            <p className="text-sm font-normal text-[#344054] pt-8 ">{says}</p>
        </div>
    )
}
