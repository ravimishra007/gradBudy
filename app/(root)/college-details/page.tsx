                                ...
                                <div className="flex flex-col items-start lg:flex-row gap-x-10 gap-y-4 mt-3 lg:mt-0">
                                    <div className="flex justify-center items-center gap-x-3">
                                        <Image
                                            ...
                                            height={20}
                                        />
                                        <p className="text-sm lg:text-lg text-[#F0F0F0] font-medium max-w-[350px]">City, District, State</p>
                                    </div>
                                    <div className="flex justify-center items-center gap-x-3">
                                        <Image
                                            className="object-cover"
                                            ...
                                            height={20}
                                        />
                                        <p className="text-sm lg:text-lg text-[#F0F0F0] font-medium max-w-[350px]">Affiliated to XYZ University</p>
                                    </div>
                                </div>
