                    ...
                    <div className='w-full lg:w-2/3 relative'>
                        ...
                        <div className="flex gap-7 mt-7">
                            <div className={`uppercase text-[#2C1C5F] flex flex-col`}>
                                <p className="font-semibold text-3xl md:text-4xl leading-tight">{calculateTotalExperience(professor?.experience) ?? 'Not found'}</p>
                                <span className="text-sm md:text-lg font-medium leading-5">Total Experience</span>
                            </div>
                            {/* <div className={`uppercase text-[#2C1C5F] flex flex-col`}>
